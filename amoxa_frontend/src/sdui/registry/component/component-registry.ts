...
export class ComponentRegistry {
  private static readonly DESCRIPTORS: readonly ComponentDescriptor[] = [
    ...
    { type: 'file_input', kind: 'control', component: 'FileInput', render: FormMappers.fileInput },
    { type: 'code_scanner', kind: 'control', component: 'CodeScanner', render: FormMappers.codeScanner },
    { type: 'sortable_list', kind: 'control', component: 'SortableList', render: FormMappers.sortableList },
