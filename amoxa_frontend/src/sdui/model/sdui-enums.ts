export const COMPONENT_TYPES = [
  ...
  'text', 'badge', 'kpi', 'progress', 'clause_tag',
  ...
  'button', 'banner', 'empty_state', 'sync_status', 'chart', 'table', 'file_input', 'code_scanner', 'sortable_list',
] as const;
...
export const USER_ROLES = ['direccion', 'gestor', 'lider', 'auditor', 'dueno_proceso', 'superusuario', 'administrador'] as const;
